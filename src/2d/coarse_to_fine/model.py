...
coarse_to_fine: Li et al., *Universal Topology Refinement* (arXiv:2409.09796).
multiview: multi-window fusion; uncertainty: extra entropy channel.
Base nnU-Net: Isensee et al., nnU-Net v2.
"""
...
class TinyUNet2d(nn.Module):
    """
    Compact 2D U-Net.
    in_channels: 2 — CT slice + coarse tumor (binary mask or probability as 2nd channel).
    """
    ...
    def _match_pad(up: torch.Tensor, skip: torch.Tensor) -> torch.Tensor:
        """Crop upsampled tensor to skip spatial size if off by 1."""
