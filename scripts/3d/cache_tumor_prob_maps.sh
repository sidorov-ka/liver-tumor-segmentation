...
#   PROB_MODEL_DIR=/path/to/nnUNetTrainer_...__3d_fullres OUTPUT_DIR=/path/to/cache bash scripts/3d/cache_tumor_prob_maps.sh
# Extra args after -- are passed to scripts/3d/cache_tumor_prob_for_multiwindow.py
set -euo pipefail
...
exec "${PYTHON}" "${REPO_ROOT}/scripts/3d/cache_tumor_prob_for_multiwindow.py" \
