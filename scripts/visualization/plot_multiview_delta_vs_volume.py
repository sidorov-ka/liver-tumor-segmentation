...
Scatter: GT tumor volume (mm³) vs ΔDice (model − baseline), plus printed statistics.
  ...
  python scripts/visualization/plot_multiview_delta_vs_volume.py
  python scripts/visualization/plot_multiview_delta_vs_volume.py --output-json visualizations/multiview_delta_stats.json
